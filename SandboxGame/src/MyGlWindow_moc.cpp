...
#include "/home/vaios/Desktop/MyEngine/ProjectFiles/SandboxGame/include/MyGlWindow.h"
...
struct qt_meta_stringdata_MyGlWindow_t {
    QByteArrayData data[3];
    char stringdata[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyGlWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyGlWindow_t qt_meta_stringdata_MyGlWindow = {
    {
QT_MOC_LITERAL(0, 0, 10),
QT_MOC_LITERAL(1, 11, 8),
QT_MOC_LITERAL(2, 20, 0)
    },
    "MyGlWindow\0myUpdate\0"
};
...
const QMetaObject MyGlWindow::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_MyGlWindow.data,
      qt_meta_data_MyGlWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyGlWindow.stringdata))
